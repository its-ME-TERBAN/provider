...
def remove_user(message):
 ...
 Usage: /remove <userid>'''
        ...
        response = "Kya Hua Bosdk Tara Nahi Chal Raha Kya Dm To Buy Accuses:- @SHIVAxHEADSHOT."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "Kya Hua Bosdk Tara Nahi Chal Raha Kya DM TO BUY:- @SHIVAxHEADSHOT."
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("Kya Hua Bosdk Tara Nahi Chal Raha Kya DM TO BUY ACCESS:- @SHIVAxHEADSHOT")
...
Official Channel :- https://t.me/HEADSHOTxSHIVA
'''
